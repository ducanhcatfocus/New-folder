  ...
  def("text/x-csharp", {
    ...
    keywords: words(
      "abstract as async await base break case catch checked class const continue" +
        ...
        " Transform Vector3 Vector2 Quaternion Material Renderer Camera AudioSource Collider Rigidbody Rigidbody2D Physics RaycastHit GameObject SpriteRenderer Animator BoxCollider SphereCollider MeshCollider MeshFilter MeshRenderer Light Shader Material Texture AudioClip Canvas RectTransform UI EventSystem Input Time Mathf Debug Application SceneManager Random Mathf Mathf.Clamp Mathf.Lerp Mathf.MoveTowards Mathf.PingPong Mathf.Repeat Mathf.SmoothStep Mathf.LerpAngle Mathf.DeltaAngle Mathf.InverseLerp Mathf.Deg2Rad Mathf.Rad2Deg Mathf.Acos Mathf.Asin Mathf.Atan Mathf.Atan2 Mathf.Cos Mathf.Sin Mathf.Tan Mathf.Ceil Mathf.Floor Mathf.Round Mathf.Sign Mathf.Clamp01 Mathf.Deg2Rad Mathf.Rad2Deg"
    ),
    types: words(
